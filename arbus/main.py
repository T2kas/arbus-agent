...
def cmd_weather(args: argparse.Namespace) -> int:
    ...
    print(f"   Botas TIK resolvina (prekybos neuždaro). Resolve ne anksčiau "
          f"{config.WEATHER_RESOLVE_MIN_HOUR}:00; anksti kai TOP užrakinta arba "
          f"maks krenta {config.WEATHER_DECLINE_HOURS}+ val.; kitaip — dienos gale.")
